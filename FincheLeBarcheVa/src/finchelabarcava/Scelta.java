 ...
 * @author studente
 */
public class Scelta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Scelta veicolo");

        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Barca a vela", "Motoscafo", "Sommergibile" };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int tipo = this.jList1.getSelectedIndex();
        Mare2 f= new Mare2(tipo);           
      //  this.tipo.setText(tipo);
        f.setVisible(true);
        f.setTitle("finche le barche va");
